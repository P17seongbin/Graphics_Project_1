    ...
    class HyperCube : Object4D
    {
        public HyperCube()
        {
...

            {
                ...
                f.Add(new Tuple<int, int, int, int, int, int>(0, 6, 5, 6, 4, 6));
                f.Add(new Tuple<int, int, int, int, int, int>(4, 6, 5, 6, 7, 6));

                f.Add(new Tuple<int, int, int, int, int, int>(0, 6, 7, 6, 4, 6));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 6, 4, 6, 6, 6));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 6, 6, 6, 7, 6));
                f.Add(new Tuple<int, int, int, int, int, int>(4, 6, 7, 6, 6, 6));

                f.Add(new Tuple<int, int, int, int, int, int>(0, 6, 7, 6, 1, 6));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 6, 5, 6, 7, 6));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 6, 1, 6, 5, 6));
                f.Add(new Tuple<int, int, int, int, int, int>(7, 6, 5, 6, 1, 6));

                f.Add(new Tuple<int, int, int, int, int, int>(0, 6, 2, 6, 7, 6));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 6, 7, 6, 6, 6));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 6, 6, 6, 2, 6));
                f.Add(new Tuple<int, int, int, int, int, int>(7, 6, 2, 6, 6, 6));

                f.Add(new Tuple<int, int, int, int, int, int>(0, 6, 3, 6, 1, 6));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 6, 1, 6, 7, 6));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 6, 7, 6, 3, 6));
                f.Add(new Tuple<int, int, int, int, int, int>(1, 6, 3, 6, 7, 6));

                f.Add(new Tuple<int, int, int, int, int, int>(0, 6, 7, 6, 2, 6));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 6, 2, 6, 3, 6));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 6, 3, 6, 7, 6));
                f.Add(new Tuple<int, int, int, int, int, int>(2, 6, 7, 6, 3, 6));
            }

            {
                f.Add(new Tuple<int, int, int, int, int, int>(8, 7, 12, 7, 15, 7));
                f.Add(new Tuple<int, int, int, int, int, int>(8, 7, 15, 7, 13, 7));
                f.Add(new Tuple<int, int, int, int, int, int>(8, 7, 13, 7, 12, 7));
                f.Add(new Tuple<int, int, int, int, int, int>(15, 7, 12, 7, 13, 7));

                f.Add(new Tuple<int, int, int, int, int, int>(8, 7, 15, 7, 12, 7));
                f.Add(new Tuple<int, int, int, int, int, int>(8, 7, 12, 7, 14, 7));
                f.Add(new Tuple<int, int, int, int, int, int>(8, 7, 14, 7, 15, 7));
                f.Add(new Tuple<int, int, int, int, int, int>(12, 7, 15, 7, 14, 7));

                f.Add(new Tuple<int, int, int, int, int, int>(8, 7, 15, 7, 9, 7));
                ...
                f.Add(new Tuple<int, int, int, int, int, int>(8, 7, 15, 7, 14, 7));
                f.Add(new Tuple<int, int, int, int, int, int>(8, 7, 14, 7, 10, 7));
                f.Add(new Tuple<int, int, int, int, int, int>(15, 7, 10, 7, 14, 7));

                f.Add(new Tuple<int, int, int, int, int, int>(8, 7, 11, 7, 9, 7));
                f.Add(new Tuple<int, int, int, int, int, int>(8, 7, 9, 7, 15, 7));
                f.Add(new Tuple<int, int, int, int, int, int>(8, 7, 15, 7, 11, 7));
                f.Add(new Tuple<int, int, int, int, int, int>(9, 7, 11, 7, 15, 7));

                f.Add(new Tuple<int, int, int, int, int, int>(8, 7, 15, 7, 10, 7));
                f.Add(new Tuple<int, int, int, int, int, int>(8, 7, 10, 7, 11, 7));
                f.Add(new Tuple<int, int, int, int, int, int>(8, 7, 11, 7, 15, 7));
                f.Add(new Tuple<int, int, int, int, int, int>(10, 7, 15, 7, 11, 7));
            }
            ////
            {
                f.Add(new Tuple<int, int, int, int, int, int>(0, 4, 8, 4, 11, 4));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 4, 11, 4, 9, 4));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 4, 9, 4, 8, 4));
                f.Add(new Tuple<int, int, int, int, int, int>(11, 4, 8, 4, 9, 4));

                f.Add(new Tuple<int, int, int, int, int, int>(0, 4, 11, 4, 8, 4));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 4, 8, 4, 10, 4));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 4, 10, 4, 11, 4));
                f.Add(new Tuple<int, int, int, int, int, int>(8, 4, 11, 4, 10, 4));

                f.Add(new Tuple<int, int, int, int, int, int>(0, 4, 11, 4, 1, 4));
                ...
                f.Add(new Tuple<int, int, int, int, int, int>(0, 4, 11, 4, 10, 4));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 4, 10, 4, 2, 4));
                f.Add(new Tuple<int, int, int, int, int, int>(11, 4, 2, 4, 10, 4));

                f.Add(new Tuple<int, int, int, int, int, int>(0, 4, 3, 4, 1, 4));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 4, 1, 4, 11, 4));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 4, 11, 4, 3, 4));
                f.Add(new Tuple<int, int, int, int, int, int>(1, 4, 3, 4, 11, 4));

                f.Add(new Tuple<int, int, int, int, int, int>(0, 4, 11, 4, 2, 4));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 4, 2, 4, 3, 4));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 4, 3, 4, 11, 4));
                f.Add(new Tuple<int, int, int, int, int, int>(2, 4, 11, 4, 3, 4));
            }

            {
                f.Add(new Tuple<int, int, int, int, int, int>(4, 5, 12, 5, 15, 5));
                f.Add(new Tuple<int, int, int, int, int, int>(4, 5, 15, 5, 13, 5));
                f.Add(new Tuple<int, int, int, int, int, int>(4, 5, 13, 5, 12, 5));
                f.Add(new Tuple<int, int, int, int, int, int>(15, 5, 12, 5, 13, 5));

                f.Add(new Tuple<int, int, int, int, int, int>(4, 5, 15, 5, 12, 5));
                f.Add(new Tuple<int, int, int, int, int, int>(4, 5, 12, 5, 14, 5));
                f.Add(new Tuple<int, int, int, int, int, int>(4, 5, 14, 5, 15, 5));
                f.Add(new Tuple<int, int, int, int, int, int>(12, 5, 15, 5, 14, 5));

                f.Add(new Tuple<int, int, int, int, int, int>(4, 5, 15, 5, 5, 5));
                ...
                f.Add(new Tuple<int, int, int, int, int, int>(4, 5, 15, 5, 14, 5));
                f.Add(new Tuple<int, int, int, int, int, int>(4, 5, 14, 5, 6, 5));
                f.Add(new Tuple<int, int, int, int, int, int>(15, 5, 6, 5, 14, 5));

                f.Add(new Tuple<int, int, int, int, int, int>(4, 5, 7, 5, 5, 5));
                f.Add(new Tuple<int, int, int, int, int, int>(4, 5, 5, 5, 15, 5));
                f.Add(new Tuple<int, int, int, int, int, int>(4, 5, 15, 5, 7, 5));
                f.Add(new Tuple<int, int, int, int, int, int>(5, 5, 7, 5, 15, 5));

                f.Add(new Tuple<int, int, int, int, int, int>(4, 5, 15, 5, 6, 5));
                f.Add(new Tuple<int, int, int, int, int, int>(4, 5, 6, 5, 7, 5));
                f.Add(new Tuple<int, int, int, int, int, int>(4, 5, 7, 5, 15, 5));
                f.Add(new Tuple<int, int, int, int, int, int>(6, 5, 15, 5, 7, 5));
            }
            ////
            {
                f.Add(new Tuple<int, int, int, int, int, int>(0, 2, 4, 2, 13, 2));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 2, 13, 2, 5, 2));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 2, 5, 2, 4, 2));
                f.Add(new Tuple<int, int, int, int, int, int>(13, 2, 4, 2, 5, 2));

                f.Add(new Tuple<int, int, int, int, int, int>(0, 2, 13, 2, 4, 2));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 2, 4, 2, 12, 2));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 2, 12, 2, 13, 2));
                f.Add(new Tuple<int, int, int, int, int, int>(4, 2, 13, 2, 12, 2));

                f.Add(new Tuple<int, int, int, int, int, int>(0, 2, 13, 2, 1, 2));
                ...
                f.Add(new Tuple<int, int, int, int, int, int>(0, 2, 13, 2, 12, 2));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 2, 12, 2, 8, 2));
                f.Add(new Tuple<int, int, int, int, int, int>(13, 2, 8, 2, 12, 2));

                f.Add(new Tuple<int, int, int, int, int, int>(0, 2, 9, 2, 1, 2));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 2, 1, 2, 13, 2));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 2, 13, 2, 9, 2));
                f.Add(new Tuple<int, int, int, int, int, int>(1, 2, 9, 2, 13, 2));

                f.Add(new Tuple<int, int, int, int, int, int>(0, 2, 13, 2, 8, 2));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 2, 8, 2, 9, 2));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 2, 9, 2, 13, 2));
                f.Add(new Tuple<int, int, int, int, int, int>(8, 2, 13, 2, 9, 2));
            }

            {
                f.Add(new Tuple<int, int, int, int, int, int>(2, 3, 6, 3, 15, 3));
                f.Add(new Tuple<int, int, int, int, int, int>(2, 3, 15, 3, 7, 3));
                f.Add(new Tuple<int, int, int, int, int, int>(2, 3, 7, 3, 6, 3));
                f.Add(new Tuple<int, int, int, int, int, int>(15, 3, 6, 3, 7, 3));

                f.Add(new Tuple<int, int, int, int, int, int>(2, 3, 15, 3, 6, 3));
                f.Add(new Tuple<int, int, int, int, int, int>(2, 3, 6, 3, 14, 3));
                f.Add(new Tuple<int, int, int, int, int, int>(2, 3, 14, 3, 15, 3));
                f.Add(new Tuple<int, int, int, int, int, int>(6, 3, 15, 3, 14, 3));

                f.Add(new Tuple<int, int, int, int, int, int>(2, 3, 15, 3, 3, 3));
                ...
                f.Add(new Tuple<int, int, int, int, int, int>(2, 3, 15, 3, 14, 3));
                f.Add(new Tuple<int, int, int, int, int, int>(2, 3, 14, 3, 10, 3));
                f.Add(new Tuple<int, int, int, int, int, int>(15, 3, 10, 3, 14, 3));

                f.Add(new Tuple<int, int, int, int, int, int>(2, 3, 11, 3, 3, 3));
                f.Add(new Tuple<int, int, int, int, int, int>(2, 3, 3, 3, 15, 3));
                f.Add(new Tuple<int, int, int, int, int, int>(2, 3, 15, 3, 11, 3));
                f.Add(new Tuple<int, int, int, int, int, int>(3, 3, 11, 3, 15, 3));

                f.Add(new Tuple<int, int, int, int, int, int>(2, 3, 15, 3, 10, 3));
                f.Add(new Tuple<int, int, int, int, int, int>(2, 3, 10, 3, 11, 3));
                f.Add(new Tuple<int, int, int, int, int, int>(2, 3, 11, 3, 15, 3));
                f.Add(new Tuple<int, int, int, int, int, int>(10, 3, 15, 3, 11, 3));
            }
            ////
            {
                f.Add(new Tuple<int, int, int, int, int, int>(0, 0, 4, 0, 14, 0));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 0, 14, 0, 12, 0));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 0, 12, 0, 4, 0));
                f.Add(new Tuple<int, int, int, int, int, int>(14, 0, 4, 0, 12, 0));

                f.Add(new Tuple<int, int, int, int, int, int>(0, 0, 14, 0, 4, 0));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 0, 4, 0, 6, 0));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 0, 6, 0, 14, 0));
                f.Add(new Tuple<int, int, int, int, int, int>(4, 0, 14, 0, 4, 0));

                f.Add(new Tuple<int, int, int, int, int, int>(0, 0, 8, 0, 14, 0));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 0, 14, 0, 12, 0));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 0, 12, 0, 8, 0));
                f.Add(new Tuple<int, int, int, int, int, int>(14, 0, 8, 0, 12, 0));

                f.Add(new Tuple<int, int, int, int, int, int>(0, 0, 2, 0, 14, 0));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 0, 14, 0, 6, 0));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 0, 6, 0, 2, 0));
                f.Add(new Tuple<int, int, int, int, int, int>(14, 0, 2, 0, 6, 0));

                f.Add(new Tuple<int, int, int, int, int, int>(0, 0, 8, 0, 10, 0));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 0, 10, 0, 14, 0));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 0, 14, 0, 8, 0));
                f.Add(new Tuple<int, int, int, int, int, int>(10, 0, 8, 0, 14, 0));

                f.Add(new Tuple<int, int, int, int, int, int>(0, 0, 2, 0, 14, 0));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 0, 14, 0, 10, 0));
                f.Add(new Tuple<int, int, int, int, int, int>(0, 0, 10, 0, 2, 0));
                f.Add(new Tuple<int, int, int, int, int, int>(14, 0, 2, 0, 10, 0));
            }

            {
                f.Add(new Tuple<int, int, int, int, int, int>(1, 1, 5, 1, 15, 1));
                f.Add(new Tuple<int, int, int, int, int, int>(1, 1, 15, 1, 13, 1));
                f.Add(new Tuple<int, int, int, int, int, int>(1, 1, 13, 1, 5, 1));
                f.Add(new Tuple<int, int, int, int, int, int>(15, 1, 5, 1, 13, 1));

                f.Add(new Tuple<int, int, int, int, int, int>(1, 1, 15, 1, 5, 1));
                f.Add(new Tuple<int, int, int, int, int, int>(1, 1, 5, 1, 7, 1));
                f.Add(new Tuple<int, int, int, int, int, int>(1, 1, 7, 1, 15, 1));
                f.Add(new Tuple<int, int, int, int, int, int>(5, 1, 15, 1, 7, 1));

                f.Add(new Tuple<int, int, int, int, int, int>(1, 1, 9, 1, 15, 1));
                f.Add(new Tuple<int, int, int, int, int, int>(1, 1, 15, 1, 13, 1));
                f.Add(new Tuple<int, int, int, int, int, int>(1, 1, 13, 1, 9, 1));
                f.Add(new Tuple<int, int, int, int, int, int>(15, 1, 9, 1, 13, 1));

                f.Add(new Tuple<int, int, int, int, int, int>(1, 1, 3, 1, 15, 1));
                f.Add(new Tuple<int, int, int, int, int, int>(1, 1, 15, 1, 7, 1));
                f.Add(new Tuple<int, int, int, int, int, int>(1, 1, 7, 1, 3, 1));
                f.Add(new Tuple<int, int, int, int, int, int>(15, 1, 3, 1, 7, 1));

                f.Add(new Tuple<int, int, int, int, int, int>(1, 1, 9, 1, 11, 1));
                f.Add(new Tuple<int, int, int, int, int, int>(1, 1, 11, 1, 15, 1));
                f.Add(new Tuple<int, int, int, int, int, int>(1, 1, 15, 1, 9, 1));
                f.Add(new Tuple<int, int, int, int, int, int>(11, 1, 9, 1, 15, 1));

                f.Add(new Tuple<int, int, int, int, int, int>(1, 1, 15, 1, 3, 1));
                f.Add(new Tuple<int, int, int, int, int, int>(1, 1, 3, 1, 11, 1));
                f.Add(new Tuple<int, int, int, int, int, int>(1, 1, 11, 1, 15, 1));
                f.Add(new Tuple<int, int, int, int, int, int>(3, 1, 15, 1, 11, 1));
            }
        }
    }
